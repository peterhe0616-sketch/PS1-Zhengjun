...
\centering
\includegraphics[width=0.82\textwidth]{figures/ps1_teaser.pdf}
\caption{Prospective research design. Each discipline column states its mechanism and the works cited for it. Free generation makes fabrication of the documents that carry information nearly costless, so the question shifts from what to disclose to which rules make honest disclosure stable~\cite{akerlof1970,spence1973,nash1950,makimattila2025}. A per-claim trace file extends the build-layer provenance that already exists~\cite{buneman2001,slsa}, but effort-free checking may license inattention~\cite{shalvi2012}; dashed boxes and arrows mark the proposed synthesis.}
