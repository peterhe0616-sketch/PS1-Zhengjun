...
\centering
\includegraphics[width=0.55\textwidth]{figures/ps1_teaser.pdf}
\caption{Prospective research design: each column states a discipline, its mechanism and its cited works. Free generation makes fabrication nearly costless, so the question becomes which rules make honest disclosure stable~\cite{akerlof1970,spence1973,nash1950,makimattila2025}.}
